                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-1">
                                <form action="{{ route('commands.destroy') }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <div class="card-body">
                        ...
                        <h2 class="text-primary">{{ $command->breeding_id }} {{ $command->quantity }}</h2>

                        <br>

                        <h3 class="text-success">Commande : </h3>
                        <br>

                        <div class="row">
                            <p class="col-4"><strong>Elevage</strong></p>
                            <p class="col">{{ $command->breeding_id }}</p>
                        </div>

                        <div class="row">
                            <p class="col-4"><strong>Quantité</strong></p>
