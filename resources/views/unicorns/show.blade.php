                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-1">
                                <a href="{{ route('unicorns.edit', $unicorn->id) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <p class="col">{{ $unicorn->unit_cost_HT }} €</p>
                        </div>
                        <div class="row">
                            <p class="col-4"><strong>Début de chaleur:</strong></p>
                            <p class="col">{{ $unicorn->date_start_mating_season }}</p>
                        </div>
                        <div class="row">
                            <p class="col-4"><strong>Période de chaleur:</strong></p>
                            <p class="col">{{ $unicorn->mating_season }}</p>
                        </div>
                        <div class="row">
