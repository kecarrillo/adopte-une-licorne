                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <a href="{{ route('breds.create') }}" title="Ajouter une Saillie">
                        ...
                        @foreach($breds as $bred)
                            <div class="row">
                                ...
                                <span class="col-2">
                                    <span class="row">
                                        <span class="col">
                                            <a href="{{ route('breds.edit', $bred->id) }}">
                                        ...
                                        <span class="col">
                                            <form action="{{ route('breds.destroy') }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <input type="hidden" name="id" value="{{ $bred->id }}">
