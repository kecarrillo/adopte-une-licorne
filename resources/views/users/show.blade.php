            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if($user->companies)
                            <div class="row">
                                <p class="col-4"><strong>Entreprise:</strong></p>
                                <p class="col">{{ $user->companies->legal_status }} {{ $user->companies->company_name }}</p>
                            </div>
                        @endif
                        ...
                        @if($user->roles)
                            @foreach($user->roles as $role)
                                <div class="row">
                                    <p class="col-4"><strong>Rôles:</strong></p>
                                    <p class="col">{{ $role->name }}</p>
                                </div>
                            @endforeach
                        @endif
